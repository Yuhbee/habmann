...
void SpielDarstellung::windAbfrage()
    {
        cout << "Der Pessimist klagt ueber den Wind, der Optimist hofft, dass er dreht, der Realist richtet das Segel aus.\n Moechtest du mit Wind spielen (die Schiffe werden vor jeder Runde zufaellig um ein Feld bewegt, je nachdem wie der Wind steht).\nJ fuer Jarrr, alles andere fuer nein\n";
    }
...
void SpielDarstellung::ueberschriftEigenesFeld(Spieler& anzeigeSpieler, Hilfsklasse::Windrichtung windrichtung)
    {
        cout << "Deine Flotte:" << endl;
        //Die Anzahl der Seetuechtigen Schiffe wird nun auch an anderer Stelle bestimmt
        int tempSchiffzahl = anzeigeSpieler.getSeetuechtigeSchiffsanzahl();
        cout << "Seetuechtige Schiffe: " << tempSchiffzahl << endl;
        cout << anzeigeSpieler.getFlottenInfoString() << endl;

        //Die Windrichtung wird nur fuer die eigene Darstellung ausgegeben, da sie fuer beide Spieler identisch ist
        if (windrichtung == Hilfsklasse::Windrichtung::Windstill)
            {
                cout << "Es ist Windstill" << endl;
            }
        else
            {
                string windString = "";
                ...
                cout << "Der Wind weht vom " << windString << " her" << endl;
            }
    }
...
void SpielDarstellung::ueberschriftTTT()
    {
